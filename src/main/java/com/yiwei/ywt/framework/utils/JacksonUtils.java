...
//                    });
            ...
            CollectionType listType = fromJSONMapper.getTypeFactory().constructCollectionType(List.class,clazz);
            list = fromJSONMapper.readValue(jsonVal, listType);
