...
CREATE TABLE `t_handle_state`  (
  ...
  `APPLY_NAME` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '申请人姓名',
  `APPLY_MOBILE` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '申请人联系方式',
  ...
  `APPLY_TYPE` int(10) NULL DEFAULT NULL COMMENT '申请人类别（1 => 户主 0 => 非户主）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '办理进度业务表' ROW_FORMAT = Dynamic;
