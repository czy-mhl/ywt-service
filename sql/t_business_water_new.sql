...
CREATE TABLE `t_business_water_new`  (
  ...
  `OWNER_NAME` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '业主名称',
  ...
  `OWNER_MOBILE` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '业主手机',
